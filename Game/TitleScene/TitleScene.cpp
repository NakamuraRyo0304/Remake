...
void TitleScene::Update()
{
	...
	if (IsCanUpdate())
	{
		...
		// 選択音を鳴らす
		if (_input->GetKeyTrack()->IsKeyPressed(KeyCode::W)  || _input->GetKeyTrack()->IsKeyPressed(KeyCode::S) ||
			_input->GetKeyTrack()->IsKeyPressed(KeyCode::Up) || _input->GetKeyTrack()->IsKeyPressed(KeyCode::Down))
		{
