...
void UI_Select::Initialize()
{
	...
	m_position.emplace(L"Stage1", SimpleMath::Vector2(50.0f, 150.0f));
	m_position.emplace(L"Stage2", SimpleMath::Vector2(50.0f, 250.0f));
	m_position.emplace(L"Stage3", SimpleMath::Vector2(50.0f, 350.0f));

	// 色の設定
	m_color.emplace(L"Editor", BLACK_COLOR);
	m_color.emplace(L"Stage1", BLACK_COLOR);
	m_color.emplace(L"Stage2", BLACK_COLOR);
	m_color.emplace(L"Stage3", BLACK_COLOR);
}
